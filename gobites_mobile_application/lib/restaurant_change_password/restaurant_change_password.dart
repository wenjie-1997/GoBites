...
class RestaurantChangePassword extends StatelessWidget {
  static route() =>
      MaterialPageRoute(builder: (context) => RestaurantChangePassword());
  @override
  Widget build(BuildContext context) {
    return ConsumerView(
        viewmodel: dependency<RestProfileViewmodel>()..initForChangePassword(),
