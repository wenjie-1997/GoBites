...
class RestaurantAddMenu extends StatelessWidget {
  static Route route() =>
      MaterialPageRoute(builder: (context) => RestaurantAddMenu());

  @override
  Widget build(BuildContext context) {
    return ConsumerView(
        viewmodel: dependency<RestaurantMenuViewmodel>()..initAddMenu(),
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          if (_viewmodel.formKeyForAdd.currentState
                              .validate()) {
                            await _viewmodel.addMenu();
                            Navigator.pop(context);
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              content: Text('A menu is added successfully.'),
