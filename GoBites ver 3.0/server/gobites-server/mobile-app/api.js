...
app.post(DOMAIN+'/login', async(req, res)=>{ const username = req.body.username;
...
app.post(DOMAIN+'/custregister', async(req, res)=>{
...
app.post(DOMAIN+'/restregister', async(req, res)=>{
...
app.get(DOMAIN+'/customer/:customerId', async(req, res) => {
...
app.get(DOMAIN+'/restaurant/:restaurantId', async(req, res) => {
...
app.get(DOMAIN+'/restaurants', async(req, res) => {
...
app.get(DOMAIN+'/restaurants/:rid', async(req, res) => {
...
app.get(DOMAIN+'/menu/:rid', async(req, res) => {
  const rid = req.params.rid;
...
app.post(DOMAIN+'/custupdate', async(req, res)=>{
...
app.post(DOMAIN+'/custupdatepassword', async(req, res)=>{
...
app.post(DOMAIN+'/restupdatepassword', async(req, res)=>{
...
app.post(DOMAIN+'/restupdate', async(req, res)=>{
...
app.post(DOMAIN+'/addmenu', async(req, res)=>{
...
app.post(DOMAIN+'/menuupdate', async(req, res)=>{
...
app.post(DOMAIN+'/menudelete', async(req, res)=>{
  const {MID} = req.body;
...
app.get(DOMAIN+'/viewcart/:cid', async(req, res)=>{
...
app.post(DOMAIN+'/addtocart', async(req, res)=>{
...
app.post(DOMAIN+'/cartdelete', async(req, res)=>{
  const {KID} = req.body;
...
app.post(DOMAIN+'/movetoorder', async(req, res)=>{
  const {CID} = req.body;
...
app.get(DOMAIN+'/vieworderid/:oid', async(req, res)=>{
...
app.get(DOMAIN+'/viewordername/:oid', async(req, res)=>{
  const oid = req.params.oid;
...
app.get(DOMAIN+'/vieworderrest/:rid', async(req, res)=>{
  const rid = req.params.rid;
...
app.get(DOMAIN+'/vieworderidcust/:cid', async(req, res)=>{
  const cid = req.params.cid;
...
app.get(DOMAIN+'/vieworderdate/:rid', async(req, res)=>{
	const rid = req.params.rid;
...
app.get(DOMAIN+'/vieworderitemrest/:oid', async(req, res)=>{
  const oid = req.params.oid;
  await db.query( `SELECT id, menuitem.itemName, quantity, menuitem.itemPrice
  FROM orderitem
  JOIN menuitem ON menuitem.mid=orderitem.fk_mid
...
app.post(DOMAIN+'/checkusername', async(req, res)=>{
...
app.get(DOMAIN+'/getcartquantity/:cid', async(req, res)=>{
  const cid = req.params.cid;
...
app.post(DOMAIN+'/orderitemdelete', async(req, res)=>{
...
app.post(DOMAIN+"/restimage", async(req, res) => {
 ...
 app.post(DOMAIN+"/image", async(req, res) => {
...
app.post(DOMAIN+'/orderitemstatus', async(req, res) => {
	const ID = req.body.ID;
	await db.query(`
...
app.post(DOMAIN+'/ordersetstatus', async(req, res) => {
